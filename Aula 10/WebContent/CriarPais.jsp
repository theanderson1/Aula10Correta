        ...
        <form action="controller.do" method="post">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="populacao" id="populacao" maxlength="15" >
                </div>

                <div class="form-group col-md-6">
                    <label for="area">Area</label>
                    <input type="area" class="form-control" name="area" id="area" required maxlength="60" placeholder="area obrigatório">
                </div>
            </div>
            <hr />
